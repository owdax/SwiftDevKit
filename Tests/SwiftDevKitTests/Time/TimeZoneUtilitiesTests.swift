...
struct TimeZoneUtilitiesTests {
    ...
    func testTimeZoneConversion() throws {
        let date = Date(timeIntervalSince1970: 1_705_881_600) // Jan 22, 2024 00:00:00 UTC
        ...
        #expect(
            nyTime.timeIntervalSince1970 == date
                .timeIntervalSince1970 + Double(nyOffset - utc.secondsFromGMT(for: date)))
        ...
        #expect(
            tokyoTime.timeIntervalSince1970 == date
                .timeIntervalSince1970 + Double(tokyoOffset - utc.secondsFromGMT(for: date)))

        // Test conversion during DST transition
        let dstDate = Date(timeIntervalSince1970: 1_710_061_200) // March 10, 2024 07:00:00 UTC (DST start in US)
    ...
    func testDateFormatting() throws {
        ...
        let afterDST = TimeZoneUtilities.format(
            date: dstDate.addingTimeInterval(7200),
            timeZone: ny,
            style: .full,
            locale: enUS)
    ...
    func testOffsetFormatting() throws {
        ...
        let beforeDSTDate = Date(timeIntervalSince1970: 1_710_050_340)
        // March 10, 2024 03:01:00 EDT (after DST)
        let afterDSTDate = Date(timeIntervalSince1970: 1_710_054_060)
