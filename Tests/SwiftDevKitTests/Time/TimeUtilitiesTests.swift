...
struct TimeUtilitiesTests {
    ...
    func testRelativeTime() throws {
        ...
        let inTwoDays = now.addingTimeInterval(172_800)
    ...
    func testDurationFormatting() throws {
        ...
        let longDuration = TimeUtilities
            .formatDuration(seconds: 7384, style: TimeUtilities.RelativeTimeStyle.long) // 2 hours, 3 minutes
        #expect(longDuration.contains("hours") && longDuration.contains("minutes"))

        let preciseDuration = TimeUtilities.formatDuration(
            seconds: 7384,
            style: TimeUtilities.RelativeTimeStyle.precise)
        #expect(
            preciseDuration.contains("hours") && preciseDuration.contains("minutes") && preciseDuration
                .contains("seconds"))
    }
    ...
    func testTimeRemaining() throws {
        ...
        // Test different styles
        let shortRemaining = TimeUtilities.timeRemaining(
            until: futureDate,
            style: TimeUtilities.RelativeTimeStyle.short)
